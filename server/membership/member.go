...
func computeMemberId(peerURLs types.URLs, clusterName string, now *time.Time) uint64 {
...
func newMember(name string, peerURLs types.URLs, memberId uint64, isLearner bool) *Member {
	m := &Member{
