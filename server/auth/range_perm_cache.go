...
func getMergedPerms(lg *zap.Logger, tx backend.IReadTx, userName string) *unifiedRangePermissions {
...
func (as *authStore) refreshRangePermCache(tx backend.IReadTx) {
...
// a2. []byte{} (in the case of string, "") is not a valid key of olive
// For representing an open-ended range, BytesAffineComparable uses []byte{} as the largest element.
// a3. []byte{0x00} is the minimum valid olive key
//
