...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ProcessStatSpec) DeepCopyInto(out *ProcessStatSpec) {
	*out = *in
	in.InitContext.DeepCopyInto(&out.InitContext)
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ProcessStatSpec.
func (in *ProcessStatSpec) DeepCopy() *ProcessStatSpec {
	if in == nil {
		return nil
	}
	out := new(ProcessStatSpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ProcessStatStatus) DeepCopyInto(out *ProcessStatStatus) {
	*out = *in
	if in.FlowNodes != nil {
		in, out := &in.FlowNodes, &out.FlowNodes
		*out = make([]*FlowNodeStat, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(FlowNodeStat)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ProcessStatStatus.
func (in *ProcessStatStatus) DeepCopy() *ProcessStatStatus {
	if in == nil {
		return nil
	}
	out := new(ProcessStatStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *RegionReplica) DeepCopyInto(out *RegionReplica) {
	*out = *in
	if in.IsNonVoting != nil {
		in, out := &in.IsNonVoting, &out.IsNonVoting
		*out = new(bool)
		**out = **in
	}
	if in.IsWitness != nil {
		in, out := &in.IsWitness, &out.IsWitness
		*out = new(bool)
		**out = **in
	}
	return
...
func (in *RegionSpec) DeepCopyInto(out *RegionSpec) {
	*out = *in
	if in.InitialReplicas != nil {
		in, out := &in.InitialReplicas, &out.InitialReplicas
