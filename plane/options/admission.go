...
import (
	...
	"github.com/olive-io/olive/plane/apiserver/admission/initializer"
)
...
func (a *AdmissionOptions) ApplyTo(
	...
	admissionPostStartHook := func(context server.PostStartHookContext) error {
		...
		go utilwait.Until(discoveryRESTMapper.Reset, 30*time.Second, context.Done())
		return nil
	}

	err = c.AddPostStartHook("start-olive-plane-admission-initializer", admissionPostStartHook)
	if err != nil {
