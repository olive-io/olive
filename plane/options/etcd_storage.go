...
import (
	...
	serverstorage "github.com/olive-io/olive/plane/storage"
)
...
func (f *StorageFactoryRestOptionsFactory) GetRESTOptions(resource schema.GroupResource, example krt.Object) (generic.RESTOptions, error) {
...
func (t *transformerStorageFactory) NewConfig(resource schema.GroupResource, example krt.Object) (*storagebackend.ConfigForResource, error) {
