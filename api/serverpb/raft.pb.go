...
// source: github.com/olive-io/olive/api/serverpb/raft.proto
...
func (*JoinRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_2d72b33508b1c846, []int{0}
}
...
func (*JoinResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_2d72b33508b1c846, []int{1}
}
...
func init() {
	proto.RegisterType((*JoinRequest)(nil), "serverpb.JoinRequest")
	proto.RegisterType((*JoinResponse)(nil), "serverpb.JoinResponse")
}

func init() {
	proto.RegisterFile("github.com/olive-io/olive/api/serverpb/raft.proto", fileDescriptor_2d72b33508b1c846)
}

var fileDescriptor_2d72b33508b1c846 = []byte{
	...
	,
}
...
func (c *raftServiceClient) Join(ctx context.Context, in *JoinRequest, opts ...grpc.CallOption) (*JoinResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/serverpb.RaftService/Join", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _RaftService_Join_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/serverpb.RaftService/Join",
	}
...
var _RaftService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "serverpb.RaftService",
	...
	Metadata: "github.com/olive-io/olive/api/serverpb/raft.proto",
}
