...
// PluginServiceApplyConfiguration represents a declarative configuration of the PluginService type for use
// with apply.
...
// PluginService constructs a declarative configuration of the PluginService type for use with
// apply.
...
func (b *PluginServiceApplyConfiguration) WithCreationTimestamp(value apismetav1.Time) *PluginServiceApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
...
func (b *PluginServiceApplyConfiguration) WithDeletionTimestamp(value apismetav1.Time) *PluginServiceApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
...
func (b *PluginServiceApplyConfiguration) WithOwnerReferences(values ...*metav1.OwnerReferenceApplyConfiguration) *PluginServiceApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
	for i := range values {
		if values[i] == nil {
...
func (b *PluginServiceApplyConfiguration) GetName() *string {
	b.ensureObjectMetaApplyConfigurationExists()
