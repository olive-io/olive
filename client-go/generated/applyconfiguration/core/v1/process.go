...
// ProcessApplyConfiguration represents a declarative configuration of the Process type for use
// with apply.
...
// Process constructs a declarative configuration of the Process type for use with
// apply.
...
func (b *ProcessApplyConfiguration) WithCreationTimestamp(value apismetav1.Time) *ProcessApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
...
func (b *ProcessApplyConfiguration) WithDeletionTimestamp(value apismetav1.Time) *ProcessApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
...
func (b *ProcessApplyConfiguration) WithOwnerReferences(values ...*metav1.OwnerReferenceApplyConfiguration) *ProcessApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
	for i := range values {
		if values[i] == nil {
...
func (b *ProcessApplyConfiguration) GetName() *string {
	b.ensureObjectMetaApplyConfigurationExists()
