...
// RunnerAffinityApplyConfiguration represents an declarative configuration of the RunnerAffinity type for use
// with apply.
type RunnerAffinityApplyConfiguration struct {
	RequiredDuringSchedulingIgnoredDuringExecution  *RunnerSelectorApplyConfiguration           `json:"requiredDuringSchedulingIgnoredDuringExecution,omitempty"`
...
// RunnerAffinityApplyConfiguration constructs an declarative configuration of the RunnerAffinity type for use with
// apply.
func RunnerAffinity() *RunnerAffinityApplyConfiguration {
	return &RunnerAffinityApplyConfiguration{}
}
...
func (b *RunnerAffinityApplyConfiguration) WithRequiredDuringSchedulingIgnoredDuringExecution(value *RunnerSelectorApplyConfiguration) *RunnerAffinityApplyConfiguration {
...
func (b *RunnerAffinityApplyConfiguration) WithPreferredDuringSchedulingIgnoredDuringExecution(values ...*PreferredSchedulingTermApplyConfiguration) *RunnerAffinityApplyConfiguration {
	for i := range values {
		if values[i] == nil {
