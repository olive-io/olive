...
type PreferredSchedulingTermApplyConfiguration struct {
	...
	Preference *RunnerSelectorTermApplyConfiguration `json:"preference,omitempty"`
}
...
func (b *PreferredSchedulingTermApplyConfiguration) WithPreference(value *RunnerSelectorTermApplyConfiguration) *PreferredSchedulingTermApplyConfiguration {
	b.Preference = value
	return b
}
