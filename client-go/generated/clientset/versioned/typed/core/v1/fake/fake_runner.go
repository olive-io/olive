...
func (c *FakeRunners) Apply(ctx context.Context, runner *corev1.RunnerApplyConfiguration, opts metav1.ApplyOptions) (result *v1.Runner, err error) {
	if runner == nil {
...
func (c *FakeRunners) ApplyStatus(ctx context.Context, runner *corev1.RunnerApplyConfiguration, opts metav1.ApplyOptions) (result *v1.Runner, err error) {
	if runner == nil {
		return nil, fmt.Errorf("runner provided to Apply must not be nil")
	}
	data, err := json.Marshal(runner)
