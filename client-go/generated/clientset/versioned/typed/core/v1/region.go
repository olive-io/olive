...
type RegionInterface interface {
	...
	Apply(ctx context.Context, region *corev1.RegionApplyConfiguration, opts metav1.ApplyOptions) (result *v1.Region, err error)
	ApplyStatus(ctx context.Context, region *corev1.RegionApplyConfiguration, opts metav1.ApplyOptions) (result *v1.Region, err error)
	RegionExpansion
}
...
func (c *regions) Apply(ctx context.Context, region *corev1.RegionApplyConfiguration, opts metav1.ApplyOptions) (result *v1.Region, err error) {
	if region == nil {
...
func (c *regions) ApplyStatus(ctx context.Context, region *corev1.RegionApplyConfiguration, opts metav1.ApplyOptions) (result *v1.Region, err error) {
	if region == nil {
		return nil, fmt.Errorf("region provided to Apply must not be nil")
	}
	patchOpts := opts.ToPatchOptions()
