...
type RunnerInterface interface {
	...
	Apply(ctx context.Context, runner *corev1.RunnerApplyConfiguration, opts metav1.ApplyOptions) (result *v1.Runner, err error)
	ApplyStatus(ctx context.Context, runner *corev1.RunnerApplyConfiguration, opts metav1.ApplyOptions) (result *v1.Runner, err error)
	RunnerExpansion
}
...
func (c *runners) Apply(ctx context.Context, runner *corev1.RunnerApplyConfiguration, opts metav1.ApplyOptions) (result *v1.Runner, err error) {
	if runner == nil {
...
func (c *runners) ApplyStatus(ctx context.Context, runner *corev1.RunnerApplyConfiguration, opts metav1.ApplyOptions) (result *v1.Runner, err error) {
	if runner == nil {
		return nil, fmt.Errorf("runner provided to Apply must not be nil")
	}
	patchOpts := opts.ToPatchOptions()
