...
var (
	...
	// but for olive we default to "WaitForReady(true)" to minimize client request error responses due to
	// transient failures.
...
// Some options are exposed to "client-go.Config".
// Defaults will be overridden by the settings in "client-go.Config".
