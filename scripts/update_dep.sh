...
# Usage:
#    ./scripts/update_deps.sh module version
# or ./scripts/update_deps.sh module
# e.g.
#   ./scripts/update_deps.sh github.com/golang/groupcache
#   ./scripts/update_deps.sh github.com/soheilhy/cmux v0.1.5
#
