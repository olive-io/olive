...
//	resp, err := dm.client.Put(ctx, key, string(data))
//	if err != nil {
//		return err
//	}
...
//	}
//	resp, err := s.v3cli.Get(ctx, key, options...)
//	if err != nil {
//		return nil, err
//	}
//	runners := make([]*pb.Runner, 0, resp.Count)
...
//	}
//	runner = new(pb.Runner)
//	_ = proto.Unmarshal(resp.Kvs[0].Value, runner)
//	return
//}
//
...
//		return nil, err
//	}
//	regions := make([]*pb.Region, 0, resp.Count)
//	for _, kv := range resp.Kvs {
...
//	}
//	region = new(pb.Region)
//	_ = proto.Unmarshal(resp.Kvs[0].Value, region)
//	return
//}
//
...
//	resp, err := s.v3cli.Put(ctx, key, string(data))
//	if err != nil {
//		return nil, err
//	}
//	instance.OliveHeader.Rev = resp.Header.Revision
//	resp.Header = s.responseHeader()
...
//	err = proto.Unmarshal(resp.Kvs[0].Value, instance)
//	if err != nil {
//		return nil, err
//	}
...
//	}
//
//	_ = proto.Unmarshal(resp.Kvs[0].Value, &dm.DefinitionMeta)
//	return dm, nil
//}
//
