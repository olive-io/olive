...
//	testPercentageOfRunnersToScore = 35
...
//}
//
//func (pl *TestScoreWithNormalizePlugin) NormalizeScore(ctx context.Context, state *framework.CycleState, region *corev1.Region, scores framework.RunnerScoreList) *framework.Status {
//	return injectNormalizeRes(pl.inj, scores)
//}
//
//func (pl *TestScoreWithNormalizePlugin) Score(ctx context.Context, state *framework.CycleState, p *corev1.Region, runnerName string) (int64, *framework.Status) {
...
//}
//
//func (pl *TestScorePlugin) PreScore(ctx context.Context, state *framework.CycleState, region *corev1.Region, runners []*framework.RunnerInfo) *framework.Status {
//	return framework.NewStatus(framework.Code(pl.inj.PreScoreStatus), injectReason)
//}
//
//func (pl *TestScorePlugin) Score(ctx context.Context, state *framework.CycleState, p *corev1.Region, runnerName string) (int64, *framework.Status) {
//	return setScoreRes(pl.inj)
//}
//
...
//}
//
//func (pl *TestPlugin) AddRegion(ctx context.Context, state *framework.CycleState, regionToSchedule *corev1.Region, regionInfoToAdd *framework.RegionInfo, runnerInfo *framework.RunnerInfo) *framework.Status {
//	return framework.NewStatus(framework.Code(pl.inj.PreFilterAddRegionStatus), injectReason)
//}
//func (pl *TestPlugin) RemoveRegion(ctx context.Context, state *framework.CycleState, regionToSchedule *corev1.Region, regionInfoToRemove *framework.RegionInfo, runnerInfo *framework.RunnerInfo) *framework.Status {
//	return framework.NewStatus(framework.Code(pl.inj.PreFilterRemoveRegionStatus), injectReason)
//}
//
...
//}
//
//func (pl *TestPlugin) Less(*framework.QueuedRegionInfo, *framework.QueuedRegionInfo) bool {
//	return false
//}
//
//func (pl *TestPlugin) Score(ctx context.Context, state *framework.CycleState, p *corev1.Region, runnerName string) (int64, *framework.Status) {
...
//}
//
//func (pl *TestPlugin) PreFilter(ctx context.Context, state *framework.CycleState, p *corev1.Region) (*framework.PreFilterResult, *framework.Status) {
...
//}
//
//func (pl *TestPlugin) Filter(ctx context.Context, state *framework.CycleState, region *corev1.Region, runnerInfo *framework.RunnerInfo) *framework.Status {
//	return framework.NewStatus(framework.Code(pl.inj.FilterStatus), injectFilterReason)
//}
//
//func (pl *TestPlugin) PostFilter(_ context.Context, _ *framework.CycleState, _ *corev1.Region, _ framework.RunnerToStatusMap) (*framework.PostFilterResult, *framework.Status) {
//	return nil, framework.NewStatus(framework.Code(pl.inj.PostFilterStatus), injectReason)
//}
//
//func (pl *TestPlugin) PreScore(ctx context.Context, state *framework.CycleState, region *corev1.Region, runners []*framework.RunnerInfo) *framework.Status {
//	return framework.NewStatus(framework.Code(pl.inj.PreScoreStatus), injectReason)
//}
//
//func (pl *TestPlugin) Reserve(ctx context.Context, state *framework.CycleState, p *corev1.Region, runnerName string) *framework.Status {
//	return framework.NewStatus(framework.Code(pl.inj.ReserveStatus), injectReason)
//}
//
//func (pl *TestPlugin) Unreserve(ctx context.Context, state *framework.CycleState, p *corev1.Region, runnerName string) {
//}
//
//func (pl *TestPlugin) PreBind(ctx context.Context, state *framework.CycleState, p *corev1.Region, runnerName string) *framework.Status {
//	return framework.NewStatus(framework.Code(pl.inj.PreBindStatus), injectReason)
//}
//
//func (pl *TestPlugin) PostBind(ctx context.Context, state *framework.CycleState, p *corev1.Region, runnerName string) {
//}
//
//func (pl *TestPlugin) Permit(ctx context.Context, state *framework.CycleState, p *corev1.Region, runnerName string) (*framework.Status, time.Duration) {
//	return framework.NewStatus(framework.Code(pl.inj.PermitStatus), injectReason), time.Duration(0)
//}
//
//func (pl *TestPlugin) Bind(ctx context.Context, state *framework.CycleState, p *corev1.Region, runnerName string) *framework.Status {
...
//}
//
//func (pl *TestPreFilterPlugin) PreFilter(ctx context.Context, state *framework.CycleState, p *corev1.Region) (*framework.PreFilterResult, *framework.Status) {
//	pl.PreFilterCalled++
//	return nil, nil
//}
//
...
//}
//
//func (pl *TestPreFilterWithExtensionsPlugin) PreFilter(ctx context.Context, state *framework.CycleState, p *corev1.Region) (*framework.PreFilterResult, *framework.Status) {
//	pl.PreFilterCalled++
//	return nil, nil
//}
//
//func (pl *TestPreFilterWithExtensionsPlugin) AddRegion(ctx context.Context, state *framework.CycleState, regionToSchedule *corev1.Region,
//	regionInfoToAdd *framework.RegionInfo, runnerInfo *framework.RunnerInfo) *framework.Status {
//	pl.AddCalled++
//	return nil
//}
//
//func (pl *TestPreFilterWithExtensionsPlugin) RemoveRegion(ctx context.Context, state *framework.CycleState, regionToSchedule *corev1.Region,
//	regionInfoToRemove *framework.RegionInfo, runnerInfo *framework.RunnerInfo) *framework.Status {
//	pl.RemoveCalled++
//	return nil
//}
//
...
//}
//
//func (dp *TestDuplicatePlugin) PreFilter(ctx context.Context, state *framework.CycleState, p *corev1.Region) (*framework.PreFilterResult, *framework.Status) {
//	return nil, nil
//}
//
...
//	return permitPlugin
//}
//func (pp *TestPermitPlugin) Permit(ctx context.Context, state *framework.CycleState, p *corev1.Region, runnerName string) (*framework.Status, time.Duration) {
...
//}
//
//func (pl *TestPreEnqueuePlugin) PreEnqueue(ctx context.Context, p *corev1.Region) *framework.Status {
//	return nil
//}
//
...
//}
//
//func (pl *TestQueueSortPlugin) Less(_, _ *framework.QueuedRegionInfo) bool {
//	return false
//}
//
...
//}
//
//func (t TestBindPlugin) Bind(ctx context.Context, state *framework.CycleState, p *corev1.Region, runnerName string) *framework.Status {
//	return nil
//}
//
...
//
//// Region is only used for logging errors.
...
//var lowPriorityRegion = &corev1.Region{
//	ObjectMeta: metav1.ObjectMeta{UID: "low"},
//	Spec:       corev1.RegionSpec{Priority: &lowPriority},
//}
//var highPriorityRegion = &corev1.Region{
//	ObjectMeta: metav1.ObjectMeta{UID: "high"},
//	Spec:       corev1.RegionSpec{Priority: &highPriority},
//}
//var runners = []*corev1.Runner{
//	{ObjectMeta: metav1.ObjectMeta{Name: "runner1"}},
//	{ObjectMeta: metav1.ObjectMeta{Name: "runner2"}},
//}
//
//var (
...
//)
//
//func newFrameworkWithQueueSortAndBind(ctx context.Context, r Registry, profile config.SchedulerProfile, opts ...Option) (framework.Framework, error) {
...
//			profile := config.SchedulerProfile{Plugins: tt.plugins}
...
//			ctx, cancel := context.WithCancel(ctx)
//			defer cancel()
//			fw, err := NewFramework(ctx, registry, &config.SchedulerProfile{Plugins: tc.plugins})
//			if err != nil {
...
//				)
//			}
//			profile := config.SchedulerProfile{Plugins: cfgPls}
...
//				ctx,
//				r,
//				config.SchedulerProfile{Plugins: &config.Plugins{PreScore: config.PluginSet{Enabled: enabled}}},
//			)
//			if err != nil {
//				t.Fatalf("Failed to create framework for testing: %v", err)
//			}
...
//		},
//		{
//			name:    "Score plugin return score greater than MaxRunnerScore",
//			plugins: buildScoreConfigDefaultWeights(scorePlugin1),
//			pluginConfigs: []config.PluginConfig{
//				{
//					Name: scorePlugin1,
//					Args: &runtime.Unknown{
//						Raw: []byte(fmt.Sprintf(`{ "scoreRes": %d }`, framework.MaxRunnerScore+1)),
//					},
//				},
//			},
//			err: true,
//		},
//		{
//			name:    "Score plugin return score less than MinRunnerScore",
//			plugins: buildScoreConfigDefaultWeights(scorePlugin1),
//			pluginConfigs: []config.PluginConfig{
//				{
//					Name: scorePlugin1,
//					Args: &runtime.Unknown{
//						Raw: []byte(fmt.Sprintf(`{ "scoreRes": %d }`, framework.MinRunnerScore-1)),
//					},
//				},
//			},
//			err: true,
//		},
//		{
//			name:    "ScoreWithNormalize plugin return score greater than MaxRunnerScore",
//			plugins: buildScoreConfigDefaultWeights(scoreWithNormalizePlugin1),
//			pluginConfigs: []config.PluginConfig{
//				{
//					Name: scoreWithNormalizePlugin1,
//					Args: &runtime.Unknown{
//						Raw: []byte(fmt.Sprintf(`{ "normalizeRes": %d }`, framework.MaxRunnerScore+1)),
//					},
//				},
//			},
//			err: true,
//		},
//		{
//			name:    "ScoreWithNormalize plugin return score less than MinRunnerScore",
//			plugins: buildScoreConfigDefaultWeights(scoreWithNormalizePlugin1),
//			pluginConfigs: []config.PluginConfig{
//				{
//					Name: scoreWithNormalizePlugin1,
//					Args: &runtime.Unknown{
//						Raw: []byte(fmt.Sprintf(`{ "normalizeRes": %d }`, framework.MinRunnerScore-1)),
//					},
//				},
//			},
//			err: true,
...
//			res, status := f.RunScorePlugins(ctx, state, region, BuildRunnerInfos(runners))
//
//			if tt.err {
//				if status.IsSuccess() {
...
//		profile := config.SchedulerProfile{Plugins: plugins}
//		ctx, cancel := context.WithCancel(context.Background())
//		defer cancel()
//
...
//		f.RunPreFilterExtensionAddRegion(ctx, state, nil, nil, nil)
//		f.RunPreFilterExtensionRemoveRegion(ctx, state, nil, nil, nil)
//
...
//			t.Errorf("AddRegion called %v, expected: 1", preFilter2.AddCalled)
//		}
//		if preFilter2.RemoveCalled != 1 {
//			t.Errorf("AddRegion called %v, expected: 1", preFilter2.RemoveCalled)
//		}
//	})
//}
//
...
//		},
//		{
//			name: "all runners are filtered out by prefilter result, but other plugins aren't executed because we consider all runners are filtered out by UnschedulableAndUnresolvable",
//			plugins: []*TestPlugin{
//				{
//					name: "reject-all-runners",
//					inj:  injectedResult{PreFilterResult: &framework.PreFilterResult{RunnerNames: sets.New[string]()}},
//				},
//				{
//					// to make sure this plugin is not executed, this plugin return Skip and we confirm it via wantSkippedPlugins.
//					name: "skip",
...
//				},
//			},
//			wantPreFilterResult: &framework.PreFilterResult{RunnerNames: sets.New[string]()},
...
//				ctx,
//				r,
//				config.SchedulerProfile{Plugins: &config.Plugins{PreFilter: config.PluginSet{Enabled: enabled}}},
//			)
//			if err != nil {
//				t.Fatalf("Failed to create framework for testing: %v", err)
//			}
...
//}
//
//func TestRunPreFilterExtensionRemoveRegion(t *testing.T) {
//	tests := []struct {
//		name               string
//		plugins            []*TestPlugin
...
//	}{
//		{
//			name: "no plugins are skipped and all RemoveRegion() returned success",
//			plugins: []*TestPlugin{
//				{
//					name: "success1",
//				},
...
//		},
//		{
//			name: "one RemoveRegion() returned error",
//			plugins: []*TestPlugin{
//				{
//					name: "success1",
//				},
//				{
//					name: "error1",
//					inj:  injectedResult{PreFilterRemoveRegionStatus: int(framework.Error)},
//				},
//			},
//			wantStatusCode: framework.Error,
//		},
//		{
//			name: "one RemoveRegion() is skipped",
//			plugins: []*TestPlugin{
//				{
//					name: "success1",
//				},
...
//			status := f.RunPreFilterExtensionRemoveRegion(ctx, state, nil, nil, nil)
//			if status.Code() != tt.wantStatusCode {
//				t.Errorf("wrong status code. got: %v, want: %v", status, tt.wantStatusCode)
//			}
//		})
...
//}
//
//func TestRunPreFilterExtensionAddRegion(t *testing.T) {
//	tests := []struct {
//		name               string
//		plugins            []*TestPlugin
//		skippedPluginNames sets.Set[string]
...
//	}{
//		{
//			name: "no plugins are skipped and all AddRegion() returned success",
//			plugins: []*TestPlugin{
//				{
//					name: "success1",
//				},
...
//		},
//		{
//			name: "one AddRegion() returned error",
//			plugins: []*TestPlugin{
//				{
//					name: "success1",
//				},
//				{
//					name: "error1",
//					inj:  injectedResult{PreFilterAddRegionStatus: int(framework.Error)},
//				},
//			},
//			wantStatusCode: framework.Error,
//		},
//		{
//			name: "one AddRegion() is skipped",
//			plugins: []*TestPlugin{
//				{
//					name: "success1",
//				},
...
//			state := framework.NewCycleState()
//			state.SkipFilterPlugins = tt.skippedPluginNames
//			status := f.RunPreFilterExtensionAddRegion(ctx, state, nil, nil, nil)
//			if status.Code() != tt.wantStatusCode {
//				t.Errorf("wrong status code. got: %v, want: %v", status, tt.wantStatusCode)
//			}
//		})
...
//			gotStatus := f.RunFilterPlugins(ctx, state, region, nil)
...
//	}{
//		{
//			name: "a single plugin makes a Region schedulable",
//			plugins: []*TestPlugin{
//				{
//					name: "TestPlugin",
...
//		},
//		{
//			name: "plugin1 failed to make a Region schedulable, followed by plugin2 which makes the Region schedulable",
//			plugins: []*TestPlugin{
//				{
//					name: "TestPlugin1",
...
//		},
//		{
//			name: "plugin1 makes a Region schedulable, followed by plugin2 which cannot make the Region schedulable",
//			plugins: []*TestPlugin{
//				{
//					name: "TestPlugin1",
//					inj:  injectedResult{PostFilterStatus: int(framework.Success)},
...
//		},
//		{
//			name: "plugin1 failed to make a Region schedulable, followed by plugin2 which makes the Region unresolvable",
//			plugins: []*TestPlugin{
//				{
//					name: "TestPlugin1",
//					inj:  injectedResult{PostFilterStatus: int(framework.Unschedulable)},
...
//		},
//		{
//			name: "both plugins failed to make a Region schedulable",
//			plugins: []*TestPlugin{
//				{
//					name: "TestPlugin1",
//					inj:  injectedResult{PostFilterStatus: int(framework.Unschedulable)},
...
//				t.Fatalf("fail to create framework: %s", err)
//			}
//			_, gotStatus := f.RunPostFilterPlugins(ctx, nil, region, nil)
...
//}
//
//func TestFilterPluginsWithNominatedRegions(t *testing.T) {
//	tests := []struct {
//		name            string
//		preFilterPlugin *TestPlugin
//		filterPlugin    *TestPlugin
//		region          *corev1.Region
//		nominatedRegion *corev1.Region
//		runner          *corev1.Runner
//		runnerInfo      *framework.RunnerInfo
//		wantStatus      *framework.Status
//	}{
//		{
//			name:            "runner has no nominated region",
//			preFilterPlugin: nil,
//			filterPlugin:    nil,
//			region:          lowPriorityRegion,
//			nominatedRegion: nil,
//			runner:          runner,
//			runnerInfo:      framework.NewRunnerInfo(region),
//			wantStatus:      nil,
//		},
//		{
//			name: "runner has a high-priority nominated region and all filters succeed",
//			preFilterPlugin: &TestPlugin{
//				name: "TestPlugin1",
//				inj: injectedResult{
//					PreFilterAddRegionStatus: int(framework.Success),
//				},
//			},
//			filterPlugin: &TestPlugin{
//				name: "TestPlugin2",
...
//			},
//			region:          lowPriorityRegion,
//			nominatedRegion: highPriorityRegion,
//			runner:          runner,
//			runnerInfo:      framework.NewRunnerInfo(region),
//			wantStatus:      nil,
//		},
//		{
//			name: "runner has a high-priority nominated region and pre filters fail",
//			preFilterPlugin: &TestPlugin{
//				name: "TestPlugin1",
//				inj: injectedResult{
//					PreFilterAddRegionStatus: int(framework.Error),
//				},
//			},
//			filterPlugin:    nil,
//			region:          lowPriorityRegion,
...
//			runner:          runner,
//			runnerInfo:      framework.NewRunnerInfo(region),
//			wantStatus:      framework.AsStatus(fmt.Errorf(`running AddRegion on PreFilter plugin "TestPlugin1": %w`, errInjectedStatus)),
//		},
//		{
//			name: "runner has a high-priority nominated region and filters fail",
//			preFilterPlugin: &TestPlugin{
//				name: "TestPlugin1",
//				inj: injectedResult{
//					PreFilterAddRegionStatus: int(framework.Success),
...
//		},
//		{
//			name: "runner has a low-priority nominated region and pre filters return unschedulable",
//			preFilterPlugin: &TestPlugin{
//				name: "TestPlugin1",
//				inj: injectedResult{
//					PreFilterAddRegionStatus: int(framework.Unschedulable),
//				},
//			},
//			filterPlugin: &TestPlugin{
//				name: "TestPlugin2",
...
//			nominatedRegion: lowPriorityRegion,
//			runner:          runner,
//			runnerInfo:      framework.NewRunnerInfo(region),
//			wantStatus:      nil,
//		},
...
//			}
//
//			regionNominator := internalqueue.NewRegionNominator(nil)
//			if tt.nominatedRegion != nil {
//				regionNominator.AddNominatedRegion(
//					logger,
//					mustNewRegionInfo(t, tt.nominatedRegion),
//					&framework.NominatingInfo{NominatingMode: framework.ModeOverride, NominatedRunnerName: runnerName})
//			}
//			profile := config.SchedulerProfile{Plugins: cfgPls}
//			ctx, cancel := context.WithCancel(context.Background())
//			defer cancel()
//			f, err := newFrameworkWithQueueSortAndBind(ctx, registry, profile, WithRegionNominator(regionNominator))
//			if err != nil {
//				t.Fatalf("fail to create framework: %s", err)
//			}
//			tt.runnerInfo.SetRunner(tt.runner)
//			gotStatus := f.RunFilterPluginsWithNominatedRegions(ctx, framework.NewCycleState(), tt.region, tt.runnerInfo)
//			if diff := cmp.Diff(gotStatus, tt.wantStatus, cmpOpts...); diff != "" {
//				t.Errorf("Unexpected status: (-got, +want):\n%s", diff)
//			}
//		})
...
//				)
//			}
//			profile := config.SchedulerProfile{Plugins: configPlugins}
//			ctx, cancel := context.WithCancel(context.Background())
//			defer cancel()
//			f, err := newFrameworkWithQueueSortAndBind(ctx, registry, profile)
//			if err != nil {
...
//			}
//
//			status := f.RunPreBindPlugins(ctx, nil, region, "")
//
...
//			}
//
//			status := f.RunReservePluginsReserve(ctx, nil, region, "")
//
//			if !reflect.DeepEqual(status, tt.wantStatus) {
//				t.Errorf("wrong status code. got %v, want %v", status, tt.wantStatus)
//			}
...
//				},
//			},
//			want: framework.NewStatus(framework.Wait, `one or more plugins asked to wait and no plugin rejected region ""`),
//		},
//		{
...
//			}
//
//			status := f.RunPermitPlugins(ctx, nil, region, "")
...
//			action:             func(f framework.Framework) { f.RunPreFilterPlugins(context.Background(), state, region) },
//			wantExtensionPoint: "PreFilter",
//			wantStatus:         framework.Success,
//		},
//		{
//			name:               "PreScore - Success",
//			action:             func(f framework.Framework) { f.RunPreScorePlugins(context.Background(), state, region, nil) },
...
//			name: "Score - Success",
//			action: func(f framework.Framework) {
//				f.RunScorePlugins(context.Background(), state, region, BuildRunnerInfos(runners))
//			},
...
//			action:             func(f framework.Framework) { f.RunReservePluginsReserve(context.Background(), state, region, "") },
//			wantExtensionPoint: "Reserve",
//			wantStatus:         framework.Success,
//		},
//		{
//			name:               "Unreserve - Success",
//			action:             func(f framework.Framework) { f.RunReservePluginsUnreserve(context.Background(), state, region, "") },
//			wantExtensionPoint: "Unreserve",
//			wantStatus:         framework.Success,
//		},
//		{
//			name:               "PreBind - Success",
//			action:             func(f framework.Framework) { f.RunPreBindPlugins(context.Background(), state, region, "") },
//			wantExtensionPoint: "PreBind",
//			wantStatus:         framework.Success,
//		},
//		{
//			name:               "Bind - Success",
//			action:             func(f framework.Framework) { f.RunBindPlugins(context.Background(), state, region, "") },
//			wantExtensionPoint: "Bind",
//			wantStatus:         framework.Success,
//		},
//		{
//			name:               "PostBind - Success",
//			action:             func(f framework.Framework) { f.RunPostBindPlugins(context.Background(), state, region, "") },
//			wantExtensionPoint: "PostBind",
//			wantStatus:         framework.Success,
//		},
//		{
//			name:               "Permit - Success",
//			action:             func(f framework.Framework) { f.RunPermitPlugins(context.Background(), state, region, "") },
...
//			profile := config.SchedulerProfile{
//				PercentageOfRunnersToScore: ptr.To[int32](testPercentageOfRunnersToScore),
...
//			}
//
//			st := fwk.RunBindPlugins(context.Background(), state, region, "")
...
//			}
//
//			f.RunPermitPlugins(ctx, nil, region, "")
//			f.WaitOnPermit(ctx, region)
//
...
//	}{
//		{
//			name: "Reject Waiting Region",
//			action: func(f framework.Framework) {
//				f.GetWaitingRegion(region.UID).Reject(permitPlugin, "reject message")
//			},
//			want: framework.NewStatus(framework.Unschedulable, "reject message").WithPlugin(permitPlugin),
//		},
//		{
//			name: "Allow Waiting Region",
//			action: func(f framework.Framework) {
//				f.GetWaitingRegion(region.UID).Allow(permitPlugin)
//			},
//			want: nil,
//		},
//	}
...
//			}
//
//			runPermitPluginsStatus := f.RunPermitPlugins(ctx, nil, region, "")
...
//	PreFilterAddRegionStatus    int                        `json:"preFilterAddRegionStatus,omitempty"`
//	PreFilterRemoveRegionStatus int                        `json:"preFilterRemoveRegionStatus,omitempty"`
...
//}
//
//func injectNormalizeRes(inj injectedResult, scores framework.RunnerScoreList) *framework.Status {
