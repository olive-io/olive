...
func (in *ExtenderArgs) DeepCopyInto(out *ExtenderArgs) {
	*out = *in
	if in.Definition != nil {
		...
		*out = new(corev1.Definition)
		(*in).DeepCopyInto(*out)
	}
	if in.Runners != nil {
		in, out := &in.Runners, &out.Runners
		*out = new(monv1.RunnerList)
		(*in).DeepCopyInto(*out)
	}
	if in.Runners != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MetaDefinition) DeepCopyInto(out *MetaDefinition) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MetaDefinition.
func (in *MetaDefinition) DeepCopy() *MetaDefinition {
	if in == nil {
		return nil
	}
	out := new(MetaDefinition)
	in.DeepCopyInto(out)
	return out
}
...
func (in *MetaVictims) DeepCopyInto(out *MetaVictims) {
	*out = *in
	if in.Definitions != nil {
		...
		*out = make([]*MetaDefinition, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(MetaDefinition)
...
func (in *Victims) DeepCopyInto(out *Victims) {
	*out = *in
	if in.Definitions != nil {
		in, out := &in.Definitions, &out.Definitions
		*out = make([]*corev1.Definition, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(corev1.Definition)
