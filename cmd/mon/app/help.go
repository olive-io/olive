...
var (
  ...
  olive-mon [flags]
    Start an olive-mon server.

  olive-mon --version
    Show the version of olive-mon.

  olive-mon -h | --help
    Show the help information about olive-mon.

  olive-mon --config-file
...
Regions:
  --region-limit '` + fmt.Sprintf("%d", mon.DefaultRegionLimit) + `'
    Sets the maximum number of regions in one runner
  --region-definitions-limit '` + fmt.Sprintf("%d", mon.DefaultRegionDefinitionsLimit) + `'
