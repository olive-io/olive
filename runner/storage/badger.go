...
func (b *storage) Get(ctx context.Context, key string, opts ...GetOption) (*Response, error) {
...
func (b *storage) Watch(ctx context.Context, key string, opts ...WatchOption) (Watcher, error) {
...
func (b *storage) Put(ctx context.Context, key string, value any, opts ...PutOption) error {
...
func (b *storage) Del(ctx context.Context, key string, opts ...DelOption) error {
...
func (b *storage) ForceSync() error {
	return b.db.Sync()
}
