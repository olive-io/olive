...
type Client struct {
	...
	scheme *apis.ReflectScheme
}

func NewClient(cfg *Config, scheme *apis.ReflectScheme) (*Client, error) {
...
func (c *Client) List(ctx context.Context, options *apidiscoveryv1.APIListOptions) (*apidiscoveryv1.APIResult, error) {
	conn, err := c.newConn()
	if err != nil {
		return nil, err
	}
...
func (c *Client) Get(ctx context.Context, options *apidiscoveryv1.APIGetOptions) (*apidiscoveryv1.APIResult, error) {
	conn, err := c.newConn()
	if err != nil {
		return nil, err
	}
...
func (c *Client) Post(ctx context.Context, options *apidiscoveryv1.APIPostOptions) error {
	conn, err := c.newConn()
	if err != nil {
		return err
	}
...
func (c *Client) Patch(ctx context.Context, options *apidiscoveryv1.APIPatchOptions) error {
	conn, err := c.newConn()
	if err != nil {
		return err
	}
...
func (c *Client) Delete(ctx context.Context, options *apidiscoveryv1.APIDeleteOptions) error {
	conn, err := c.newConn()
	if err != nil {
		return err
	}
