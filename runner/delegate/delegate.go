...
type Theme struct {
	Major types.FlowNodeType `json:"major"`
...
func Init(cfg *Config) error {
	var err error
	once.Do(func() {
		internalController, err = NewControllerWithTree(cfg, router)
		if err != nil {
			return
		}
...
func NewController(cfg *Config) (*Controller, error) {
	return NewControllerWithTree(cfg, New())
}

func NewControllerWithTree(cfg *Config, tree *Tree) (*Controller, error) {
