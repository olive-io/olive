	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.MonV1().Runners().List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.MonV1().Runners().Watch(context.TODO(), options)
			},
		},
		&monv1.Runner{},
		resyncPeriod,
...
func (f *runnerInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&monv1.Runner{}, f.defaultInformer)
}
