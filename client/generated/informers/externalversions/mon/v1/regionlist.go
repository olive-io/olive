	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.MonV1().RegionLists().List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.MonV1().RegionLists().Watch(context.TODO(), options)
			},
		},
		&monv1.RegionList{},
		resyncPeriod,
...
func (f *regionListInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&monv1.RegionList{}, f.defaultInformer)
}
