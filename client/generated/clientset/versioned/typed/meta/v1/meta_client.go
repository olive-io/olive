...
// MetaV1Client is used to interact with features provided by the meta.olive.io group.
type MetaV1Client struct {
	restClient rest.Interface
}

func (c *MetaV1Client) Regions() RegionInterface {
	return newRegions(c)
}

func (c *MetaV1Client) RegionLists() RegionListInterface {
	return newRegionLists(c)
}

func (c *MetaV1Client) Runners() RunnerInterface {
	return newRunners(c)
}

func (c *MetaV1Client) RunnerLists() RunnerListInterface {
