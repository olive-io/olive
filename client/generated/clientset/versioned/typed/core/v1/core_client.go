...
type OliveV1Interface interface {
	...
	DefinitionsGetter
	DefinitionListsGetter
	ProcessInstancesGetter
	ProcessInstanceListsGetter
}
...
func (c *OliveV1Client) DefinitionLists(namespace string) DefinitionListInterface {
	return newDefinitionLists(c, namespace)
}
...
func (c *OliveV1Client) ProcessInstanceLists(namespace string) ProcessInstanceListInterface {
	return newProcessInstanceLists(c, namespace)
}
