...
// This function translates endpoints names supported by olive server into
...
//   - olive supports unixs & https names as opposed to unix & http to
//     distinguish need to configure certificates.
//   - olive support http(s) names as opposed to tcp supported by grpc/dial method.
//   - olive supports unix(s)://local-file naming schema
