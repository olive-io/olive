...
// IsMultiVersion returns true if the multiVersion field is true.
func (op Op) IsMultiVersion() bool { return op.multiVersion }
...
func OpPut(key, val string, opts ...OpOption) Op {
	...
	case ret.multiVersion:
		panic("unexpected multi version in put")
	case ret.countOnly:
...
// WithMultiVersion makes 'Get' request multi version.
func WithMultiVersion() OpOption {
	return func(op *Op) { op.multiVersion = true }
}
