...
func NewLease(c *Client) ILease {
	return NewLeaseFromLeaseClient(RetryLeaseClient(c), c, c.cfg.DialTimeout+time.Second)
}

func NewLeaseFromLeaseClient(remote pb.LeaseClient, c *Client, keepAliveTimeout time.Duration) ILease {
	l := &lessor{
...
func (l *lessor) Leases(ctx context.Context) (*LeaseLeasesResponse, error) {
	...
	if err == nil {
		...
		return &LeaseLeasesResponse{ResponseHeader: resp.Header, Leases: leases}, nil
	}
	return nil, toErr(ctx, err)
}
